...
return array(
    'validate_required'                 => '{field}是必须的',
    'validate_valid_email'              => '{field}必须是一个合法的邮件地址',
    'validate_max_len'                  => '{field}长度至多为{param}',
    'validate_min_len'                  => '{field}长度至少为{param}',
    'validate_exact_len'                => '{field}长度只能为{param}',
    ...
    'validate_contains'                 => '{field}只能是下列的值：{param}',
    ...
    'validate_equalsfield'              => '{field}和{param}必须一致',
